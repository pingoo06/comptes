	...
	public void finaliseRappro() {
		...
		if(soldePointe.equals(mntFinal.replace(".", ","))){
			try {
				...
				Files.move(Paths.get("res/bnp.csv"), Paths.get("C:\\Users\\miche.MICROBE\\Financier\\Documents\\Pour comptes\\Fichiers pointés ok\\"+fileName), StandardCopyOption.ATOMIC_MOVE);
			} catch (IOException e) {
